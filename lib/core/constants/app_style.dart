...
class AppStyle {
  ...
  static ThemeData darkTheme = ThemeData(
      ...
      brightness: Brightness.dark,
      inputDecorationTheme: InputDecorationTheme(
        iconColor: Color(0xFFE8E9ED),
        labelStyle: TextStyle(color: Color(0xFFE8E9ED)),
        enabledBorder: bottomLightInputBorder,
        focusedBorder: bottomLightInputBorder,
        border: bottomLightInputBorder,
      ),
      ...
      textTheme: const TextTheme(
        bodyText1: TextStyle(color: Color(0xFFE8E9ED)),
        bodyText2: TextStyle(color: Color(0xFFE8E9ED)),
        caption: TextStyle(color: Color(0xFFE8E9ED)),
        headline1: TextStyle(color: Color(0xFFE8E9ED)),
        headline2: TextStyle(color: Color(0xFFE8E9ED)),
        headline3: TextStyle(color: Color(0xFFE8E9ED)),
        headline4: TextStyle(color: Color(0xFFE8E9ED)),
        headline5: TextStyle(color: Color(0xFFE8E9ED)),
        headline6: TextStyle(color: Color(0xFFE8E9ED)),
        subtitle1: TextStyle(color: Color(0xFFE8E9ED)),
