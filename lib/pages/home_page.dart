...
import 'package:flutter_sandik/core/constants/widget.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  _goToAppInfo(){
   ConstWidget.showCustomAlertDialog(context,
   header: Container(
    decoration: BoxDecoration(
              color: AppStyle.deepBlue,
    ...
    padding: EdgeInsets.only(left: 8),
     child: Row(
      ...
      SizedBox(width: 8,),
      Text("Sandix",style: TextStyle(color: Colors.white),)
     ],),
   ),
   body: Container(
    child:Text("This app generated by Mohammad and powerd by flutter and firestore for manage your routin daily payments")
   ),
   actions: [ElevatedButton(onPressed: (){Navigator.of(context).pop();}, child: (Text("Ok",style: Theme.of(context).textTheme.subtitle2,)))]);
